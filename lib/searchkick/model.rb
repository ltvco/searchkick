module Searchkick
  module Model
    def searchkick(**options)
      ...
      include(mod)
      mod.module_eval do
        def reindex(method_name = nil, mode: nil, refresh: false, ignore_missing: nil, job_options: nil, use_bulk_queue: false)
          self.class.searchkick_index.reindex([self], method_name: method_name, mode: mode, refresh: refresh, ignore_missing: ignore_missing, job_options: job_options, single: true, use_bulk_queue: use_bulk_queue)
