...
module Searchkick
  ...
  class << self
    attr_accessor :search_method_name, :timeout, :models, :client_options, :redis, :index_prefix, :index_suffix, :queue_name, :bulk_queue_name, :model_options, :client_type, :parent_job
  ...
  self.bulk_queue_name = :searchkick_bulk
  self.model_options = {}
